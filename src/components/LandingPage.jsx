...
function LandingPage() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className="w-full h-screen bg-[#fff8ef] pt-1">
        <div className="textstructure mt-60 px-20">
            {["WE CREATE", "EYE OPENING", "PRESENTATIONS"].map((item, index)=> {
                ...
                <h1 className="uppercase font-bold text-[#030100] tracking-tighter leading-[6.5vw]">
                    {item}
                </h1>
                </div>
            </div>
