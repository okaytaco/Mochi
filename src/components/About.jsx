...
function About() {
  return (
    <div className="w-full py-20 px-20 bg-[#846039] rounded-tl-3xl rounded-tr-3xl text-black">
      ...
      <div className="w-full flex gap-5 border-t-[1px] mt-20 pt-10">
        ...
        <button className="flex gap-10 items-center px-10 py-8 bg-[#030100] mt-10 rounded-full text-[#fff8ef]">READ MORE
          <div className="w-3 h-3 bg-zinc-100 rounded-full"></div>
        </button>
        </div>
        <img src="/assets/brown.jpeg" className="w-1/2 h-[70vh] rounded-3xl" />
